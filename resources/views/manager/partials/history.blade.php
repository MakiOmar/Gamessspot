            ...
            <div class="card-body">
                <div class="vertical-timeline vertical-timeline--animate vertical-timeline--one-column">
                    ...
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            <span class="vertical-timeline-element-icon bounce-in">
                                <i class="badge bg-success rounded-circle badge-dot-xl">&nbsp;</i>
                            </span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <h4 class="timeline-title">Meeting with client</h4>
                                <p>Meeting with USA Client, today at 
                    ...
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            <span class="vertical-timeline-element-icon bounce-in">
                                <i class="badge bg-warning rounded-circle badge-dot-xl">&nbsp;</i>
                            </span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <p>Another meeting with UK client today, at 
                    ...
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            <span class="vertical-timeline-element-icon bounce-in">
                                <i class="badge bg-danger rounded-circle badge-dot-xl">&nbsp;</i>
                            </span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <h4 class="timeline-title">Discussion with team about new product launch</h4>
                                <p>Meeting with teammates about the launch of the new product and explaining the new features.</p>
                    ...
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            <span class="vertical-timeline-element-icon bounce-in">
                                <i class="badge bg-primary rounded-circle badge-dot-xl">&nbsp;</i>
                            </span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <h4 class="timeline-title text-success">Discussion with marketing team</h4>
                                <p>Discussion with the marketing team about the popularity of the last product.</p>
                    ...
                    <div class="vertical-timeline-item vertical-timeline-element">
                        <div>
                            ...
                            <div class="vertical-timeline-element-content bounce-in">
                                ...
                                <p>Purchased a new hosting plan as discussed with the development team, today at 
