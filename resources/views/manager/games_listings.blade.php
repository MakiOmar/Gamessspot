    ...
    <div class="row">
        ...
        @foreach($psGames as $game)
            <div class="col-md-4 mb-4">
                <div class="card">
                    @php
                        // Dynamically construct the image URL and stock column names based on $n
                    ...
                    <!-- Dynamically set the background image using the dynamically constructed URL -->
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <!-- Offline Button -->
                            <a title="Offline" 
                            class="d-inline-flex justify-content-center align-items-center rounded text-light font-weight-bold" 
                            style="padding:10px;background-color: #f64e60;">
                                {!! $up !!}{{ $game->$offline_stock }} 
                                <span>&nbsp;|&nbsp;</span> 
                                {!! $moneyIcon !!}{{ $game->ps4_offline_price }}
                            </a>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <!-- Primary Button -->
                            <a title="Primary" 
                            class="d-inline-flex justify-content-center align-items-center rounded text-light font-weight-bold m-2" 
                            style="padding:10px;background-color: #1bc5bd;">
                                {!! $up !!}{{ $game->$primary_stock }} 
                                <span>&nbsp;|&nbsp;</span> 
                                {!! $moneyIcon !!}{{ $game->ps4_primary_price }}
                            </a>
            
                            <!-- Secondary Button -->
                            <a title="Secondary" 
                            class="d-inline-flex justify-content-center align-items-center rounded text-light font-weight-bold m-2" 
                            style="padding:10px;background-color: #ffa800;">
                                {!! $up !!}{{ $game->$secondary_stock }} 
                                <span>&nbsp;|&nbsp;</span> 
                                {!! $moneyIcon !!}{{ $game->ps4_secondary_price }}
                            </a>
                        </div>
                    </div>
                </div>
