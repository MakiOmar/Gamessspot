<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="btn" id="menu-toggle" style="color: #32BEA6;font-size:20px">
            <i class="fa-solid fa-bars"></i>
        </a>
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <!-- User Icon with Link to Edit User Page -->
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('manager.users.edit', ['id' => auth()->user()->id]) }}" title="Edit Profile">
